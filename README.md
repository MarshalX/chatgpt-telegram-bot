...
| `MAX_OUTPUT_TOKENS`                        | Upper bound on how many tokens the ChatGPT API will return                                                                                                                                                                                                                              | `1200` for GPT-3, `2400` for GPT-4 |
| `VISION_MAX_OUTPUT_TOKENS`                 | Upper bound on how many tokens vision models will return                                                                                                                                                                                                                                | `300` for gpt-4-vision-preview     |
...
| `VISION_PROMPT_FILE`                | Path to a text file containing the vision prompt. If the file exists, its content will be used instead of the `VISION_PROMPT` environment variable                                                                                                                                      | `prompts/vision_prompt.txt`        |
...
| `ASSISTANT_PROMPT_FILE`             | Path to a text file containing the assistant prompt. If the file exists, its content will be used instead of the `ASSISTANT_PROMPT` environment variable                                                                                                                                 | `prompts/assistant_prompt.txt`     |
...
| `WHISPER_PROMPT_FILE`               | Path to a text file containing the whisper prompt. If the file exists, its content will be used instead of the `WHISPER_PROMPT` environment variable                                                                                                                                    | `prompts/whisper_prompt.txt`       |
